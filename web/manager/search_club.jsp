...
<form method="post" action="second_search_club.jsp" target="right">
...
<%
    ...
    for(int i=0;i<presidents.size();i++){
        ...
        sql1="select * from club where Cname='"+president.getCname()+"' and Cname like '%"+name+"%'";
        ArrayList clubs = new Dao.Club.clubMessage().querryClub(sql1);
        if(clubs.size()==0){
            continue;
        }
        ClubBean club = (ClubBean) clubs.get(0);
